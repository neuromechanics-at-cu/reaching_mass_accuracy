...
#setwd(pref_plots_dir)
if (save_plots){
  ggsave('GRAPHS/Preferred/Movedur_by_experiment.pdf',plot=Movedur_by_experiment+theme(text = element_text(size = 18)),width=12,height=8, useDingbats = FALSE)
}
...
#setwd(pref_plots_dir)
if (save_plots){
  ggsave('GRAPHS/Preferred/movedur_norm_by_experiment.pdf',plot=Movedur_norm_by_experiment+theme(text = element_text(size = 18)),width=12,height=8, useDingbats = FALSE)
}
...
#setwd(pref_plots_dir)
if (save_plots){
  ggsave('GRAPHS/Preferred/peakvel_norm_by_experiment.pdf',plot=Peakvel_norm_by_experiment+theme(text = element_text(size = 18)),width=12,height=8, useDingbats = FALSE)
}
...
#setwd(pref_plots_dir)
if (save_plots){
  ggsave('GRAPHS/Preferred/miss_dist_norm_by_experiment.pdf',plot=Miss_dist_norm_by_experiment+theme(text = element_text(size = 18)),width=12,height=8, useDingbats = FALSE)
}
...
#setwd(pref_plots_dir)
if (save_plots){
  ggsave('GRAPHS/Preferred/Pref_results_grouped.pdf',plot=pref_grouped,width=9/.9,height=12, useDingbats = FALSE)
}
...
if (save_plots){
  #setwd(met_plots_dir)
  ggsave('GRAPHS/Metabolics/MPGross_by_movedur_met.pdf',plot=MPGross,height = 6, width = 8, useDingbats = FALSE, path = met_plots_dir)
}
...
#setwd(met_plots_dir)
if (save_plots){ggsave('GRAPHS/Metabolics/MPNet_by_movedur.pdf',plot = MPNet,height = 6, width = 8, useDingbats = FALSE)}
...
if (save_plots){
  #setwd(met_plots_dir)
  ggsave('GRAPHS/Metabolics/MCostGross_by_movedur_met.pdf',plot=MCGross,height = 6, width = 8, useDingbats = FALSE, path = met_plots_dir)
}
...
temppref = cbind(c(2.506,3.959,4.894,5.282),
                 MCostmin_obj, 
                 MCostmin_dur, 
                 aggregate(movedur ~ eff_mass,prefdata,mean)$movedur)
...
#setwd(met_plots_dir)
if (save_plots){
  ggsave('GRAPHS/Metabolics/MCostNet_by_movedur.pdf',plot=MCNet,height = 6, width = 8, useDingbats = FALSE, path = met_plots_dir)
}
...
#setwd(met_plots_dir)
if (save_plots){ggsave('GRAPHS/Metabolics/Met_results_r.pdf',plot=met_results,width=6,height=7, device=cairo_pdf)}
```
...
#setwd(pref_plots_dir)
if (save_plots){ggsave(filename='GRAPHS/Preferred/p_alpha_plot_cont2.pdf',plot=p_alpha_plot_cont2,height=6,width=9,useDingbats=FALSE)}
...
#setwd(pref_plots_dir)
if (save_plots){ggsave(filename='GRAPHS/Preferred/utilfits_by_exp_3alphas.pdf',plot=utilfits_by_exp_3alphas,height=4,width=6,useDingbats=FALSE)}
...
#setwd(pref_plots_dir)
if (save_plots){ggsave(filename='GRAPHS/Preferred/utilfits_by_exp_2alphas.pdf',plot=utilfits_by_exp_2alphas,height=8,width=12,useDingbats=FALSE)}
...
#setwd(pref_plots_dir)
if (save_plots){ggsave('GRAPHS/Preferred/grouped_utility_movedur.pdf',plot=grouped_utility_movedur,width=9/.8,height=9, useDingbats = FALSE)}
...
```{r utilfits2alphas, echo = FALSE, warning = FALSE, fig.width=12, fig.height=9, fig.cap = 'Utility fits across experiments.'}
  ...
  #setwd(pref_plots_dir)
  if (save_plots){ggsave(filename='GRAPHS/Preferred/utilfits_by_exp_2alphas.pdf',plot=utilfits_by_exp_2alphas,height=4,width=6,useDingbats=FALSE)}
  utilfits_by_exp_2alphas+
     theme(text=element_text(size=16),
           legend.position = 'none')
```
...
#setwd(pref_plots_dir)
if (save_plots){ggsave('GRAPHS/Preferred/alt_ut_SSE_group_plot.pdf',plot=alt_ut_SSE_group_plot, width = 8, height = 8, useDingbats = FALSE)}
```
...
#setwd(pref_plots_dir)
if (save_plots){ggsave('GRAPHS/Preferred/alt_ut_SSE_norm_group_plot.pdf',plot=alt_ut_SSE_norm_group_plot, width = 8, height = 8, useDingbats = FALSE)}
```
...
#setwd(pref_plots_dir)
if (save_plots){ggsave('GRAPHS/Preferred/alt_ut_SSE_absnorm_group_plot.pdf',plot=alt_ut_SSE_absnorm_group_plot, width = 10, height = 8, useDingbats = FALSE)}
```
...
theme_set(theme_cowplot(font_size=7.76))
#setwd(pref_plots_dir)
if (save_plots){ggsave(filename='GRAPHS/Preferred/ut_pred_plot.pdf',plot=ut_pred_plot,
                       height=4,
                       width=6,
                       useDingbats=FALSE)}
ut_pred_plot
...
model_labs = c(latex2exp::TeX("'2a Duration'"),
               latex2exp::TeX("'2b Duration'"),
               latex2exp::TeX("'3c Duration'"),
               latex2exp::TeX("'2a Util'"),
               latex2exp::TeX("'2b Util'"),
               latex2exp::TeX("'2c Util'"),
               latex2exp::TeX("'Net Cost'"),
               latex2exp::TeX("'Gross Cost'"),
               latex2exp::TeX("'$Torque^2$'"),
               latex2exp::TeX("'4'"),
               latex2exp::TeX("'5'"),
               latex2exp::TeX("'6'"),
               latex2exp::TeX("'8'"),
...
#setwd(pref_plots_dir)
if (save_plots){ggsave('GRAPHS/Preferred/Model_movedur_shape.pdf',plot=Model_movedur_shape, width = 7, height = 5, useDingbats = FALSE)}
...
#setwd(pref_plots_dir)
if (save_plots){ggsave('GRAPHS/Preferred/Results_model_r_shape.pdf',plot = Results_model_r_shape, height = 8, width = 8/.85, useDingbats = FALSE)}
...
model_labs = c(latex2exp::TeX("'$Mass^1$'"),
               latex2exp::TeX("'$Mass^2$'"),
               latex2exp::TeX("'$Torque^2$'"),
               latex2exp::TeX("'Met Cost\nGross'"),
               latex2exp::TeX("'Met Cost\nNet'"),
               latex2exp::TeX("'Preferred\nDuration'"),
               latex2exp::TeX("'Utility Gross'"),
               latex2exp::TeX("'Utility Net'"),
               latex2exp::TeX("'Utility Gross'"),
               latex2exp::TeX("'Utility Net'"),
               latex2exp::TeX("'Utility Gross\nComb Alpha'"),
               latex2exp::TeX("'Utility Net\nComb Alpha'"),
               latex2exp::TeX("'Accuracy Prob'"))
models_to_plot = c(3,4,5,6,9,10,11,12)
temp_durs = filter(model_durs, modelnum %in% models_to_plot)
